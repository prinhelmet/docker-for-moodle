...
echo "Eliminado paquete de idioma: es.zip"
rm -f es.zip
...
echo "Eliminado paquete de idioma: ca.zip"
rm -f ca.zip
...
echo "Eliminado paquete de idioma: ca_valencia.zip"
...
echo "Eliminado paquete de idioma: eu.zip"
rm -f eu.zip
...
echo "Eliminado paquete de idioma: ast.zip"
rm -f ast.zip
...
echo "Eliminado paquete de idioma: gl.zip"
rm -f gl.zip
